window.addEventListener("load", () => {
  ...
  const openSearch = () => {
    ...
    EraYes.animateIn($searchMask, "to_show 0.5s");
    EraYes.animateIn(document.querySelector("#local-search .search-dialog"), "titleScale 0.5s");
    setTimeout(() => {
  ...
  const closeSearch = () => {
    ...
    bodyStyle.width = "";
    bodyStyle.overflow = "";
    EraYes.animateOut(document.querySelector("#local-search .search-dialog"), "search_close .5s");
    EraYes.animateOut($searchMask, "to_hide 0.5s");
  };
  ...
  const search = () => {
    ...
    $input.addEventListener("input", function () {
      ...
      if (keywords[0] !== "")
        $loadingStatus.innerHTML = '<i class="fa-solid fa-spinner EraYes-pulse-icon"></i>';
  ...
  window.addEventListener("pjax:complete", () => {
    !EraYes.isHidden($searchMask) && closeSearch();
    searchClickFn();
  });
});
