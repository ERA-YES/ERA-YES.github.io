window.addEventListener("load", () => {
  const openSearch = () => {
    ...
    EraYes.animateIn(document.getElementById("search-mask"), "to_show 0.5s");
    EraYes.animateIn(document.querySelector("#algolia-search .search-dialog"), "titleScale 0.5s");
    setTimeout(() => {
  ...
  const closeSearch = () => {
    ...
    bodyStyle.width = "";
    bodyStyle.overflow = "";
    EraYes.animateOut(document.querySelector("#algolia-search .search-dialog"), "search_close .5s");
    EraYes.animateOut(document.getElementById("search-mask"), "to_hide 0.5s");
  };
  ...
  const search = instantsearch({
    ...
    searchFunction(helper) {
      if (helper.state.query) {
        let innerLoading = '<div class="fa-solid fa-spinner EraYes-spin"></div>';
  ...
  const hits = instantsearch.widgets.hits({
    ...
    templates: {
      item(data) {
        ...
        const loadingLogo = document.querySelector("#algolia-hits .EraYes-spin");
        if (loadingLogo) {
